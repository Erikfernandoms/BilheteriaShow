...
from app.controllers.integration.pagamentos.routes import router as pagamentos_router
...
app.include_router(pagamentos_router, prefix="/pagamento", tags=["mock pagamento"])
